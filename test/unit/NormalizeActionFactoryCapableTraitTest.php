...
use Dhii\Action\NormalizeActionFactoryCapableTrait as TestSubject;
 ...
 * @since [*next-version*]
 */
class NormalizeActionFactoryCapableTraitTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Action\NormalizeActionFactoryCapableTrait';
     ...
     * @since [*next-version*]
     */
    public function testNormalizeActionFactoryIsValid()
    {
        $action = uniqid('action-factory');
        ...
        $action = $_subject->_normalizeActionFactory($action);
    }
}
